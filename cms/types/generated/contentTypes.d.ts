...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    beyondCode: Schema.Attribute.RichText &
      Schema.Attribute.Required &
    ...
    goals: Schema.Attribute.RichText &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    thankingMessage: Schema.Attribute.RichText &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['normal', 'reply']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiNotificationNotification
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['react', 'unreact', 'comment', 'deleteComment', 'ban', 'unban']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface PluginUsersPermissionsUser
  ...
  info: {
    description: 'Users for authentication and content interactions';
    displayName: 'User';
    pluralName: 'users';
    singularName: 'user';
  };
  ...
  attributes: {
    accountStatus: Schema.Attribute.Enumeration<['active', 'banned']> &
